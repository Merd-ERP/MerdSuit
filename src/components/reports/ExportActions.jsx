  ...
  function exportCsv() {
    try {
      ...
      showToast({
        type: "success",
        title: "CSV exported",
        message: "The selected report was exported successfully.",
      });
    } catch {
      showToast({
        type: "error",
        title: "CSV export failed",
        message: "Unable to export the selected report as CSV.",
      });
    }
  }
  ...
  async function exportPdf() {
    try {
      ...
      showToast({
        ...
        message: "Unable to export the selected report as PDF.",
      });
    }
  }
