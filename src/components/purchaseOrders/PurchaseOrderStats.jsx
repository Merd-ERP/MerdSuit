...
function PurchaseOrderStats() {
  ...
  const stats = [{ label: "Total Orders", value: purchaseOrders.length, color: "text-blue-600" }, { label: "Pending Orders", value: pending, color: "text-amber-600" }, { label: "Received Orders", value: received, color: "text-emerald-600" }, { label: "Total Purchase Value", value: formatCurrency(totalValue), color: "text-slate-800" }];
