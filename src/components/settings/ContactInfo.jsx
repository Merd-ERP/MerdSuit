  ...
  return (
    <Card>
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        ...
        <label className="text-sm font-medium text-slate-700">Email Address<input name="email" type="email" value={company.email} onChange={onChange} className="mt-1 w-full rounded-lg border border-slate-300 p-3" />{errors.email && <span className="mt-1 block text-sm text-red-600">{errors.email}</span>}</label>
