...
function QuotationStats() {
  ...
  const stats = [{ label: "Total Quotations", value: quotations.length, color: "text-blue-600" }, { label: "Accepted", value: accepted, color: "text-emerald-600" }, { label: "Quotation Value", value: formatCurrency(total), color: "text-slate-800" }];
